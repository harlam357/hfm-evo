...
public class ClientResourceTests
{
    ...
    public class GivenClientResourceHasRunningStatus : ClientResourceTests
    {
        ...
        public class WhenWorkUnitHasFrames : GivenClientResourceHasRunningStatus
        {
            ...
            public void ThenFrameTimeIsCalculated() =>
                Assert.That(_resource!.GetFrameTime(PpdCalculation.LastThreeFrames), Is.EqualTo(TimeSpan.FromMinutes(1)));
            ...
            public void ThenEtaIsCalculated() =>
                Assert.That(_resource!.GetEta(PpdCalculation.LastThreeFrames), Is.Not.EqualTo(TimeSpan.Zero));

            [Test]
            public void ThenEtaDateIsCalculated() =>
                Assert.That(_resource!.GetEtaDate(PpdCalculation.LastThreeFrames), Is.Not.EqualTo(_resource.WorkUnit!.UnitRetrievalTime));
        }
    }
    ...
    public class GivenClientResourceHasPausedStatus : ClientResourceTests
    {
        ...
        public class WhenWorkUnitHasFrames : GivenClientResourceHasPausedStatus
        {
            ...
            public void ThenZeroFrameTimeIsCalculated() =>
                Assert.That(_resource!.GetFrameTime(PpdCalculation.LastThreeFrames), Is.EqualTo(TimeSpan.Zero));
            ...
            public void ThenBaseCreditIsCalculated() =>
                Assert.That(_resource!.GetCredit(PpdCalculation.LastThreeFrames, BonusCalculation.FrameTime), Is.EqualTo(1000.0));

            [Test]
            public void ThenZeroEtaIsCalculated() =>
                Assert.That(_resource!.GetEta(PpdCalculation.LastThreeFrames), Is.EqualTo(TimeSpan.Zero));

            [Test]
            public void ThenMinimumEtaDateIsCalculated() =>
                Assert.That(_resource!.GetEtaDate(PpdCalculation.LastThreeFrames), Is.EqualTo(DateTime.MinValue));
        }
    }
    ...
    public class GivenClientResourceWithWorkUnitAndProtein : ClientResourceTests
    {
        ...
        public void ThenCoreValueIsReturned() =>
            Assert.That(_resource!.GetCore(false), Is.EqualTo("0x22"));

        [Test]
        public void ThenCoreValueAndVersionAreReturned() =>
            Assert.That(_resource!.GetCore(true), Is.EqualTo("0x22 (0.0.20)"));
    }
}
